...
for num_train in range(50):
        ...
        while not env.get_done():
            ...
            if episode_step < 129:
                ...
                if random.uniform(0, 1) > epsilon:
                    Explore = True
                # if Explore:
                #     action_explore = random.randint(0, 2)
                for i in range(10):
                    s_i = int(red_obs[i])
                    s_now_list[i] = s_i
                    if Explore == False:
    ...
    # result_name = str(result_num)
        ...
        if SCORES[int((num_game+1)/10)-1] > 4000:
            address1 = 'D:/marl_result/train_scores1/score'
            address2 = 'D:/marl_result/train_scores1/Q_table_list'
            address3 = 'D:/marl_result/train_scores1/red_alive'
            address4 = 'D:/marl_result/train_scores1/red_dead'
            address5 = 'D:/marl_result/train_scores1/blue_alive'
            address6 = 'D:/marl_result/train_scores1/blue_dead'
            address7 = 'D:/marl_result/train_scores1/kill_missile'
            address8 = 'D:/marl_result/train_scores1/winning_rate'
