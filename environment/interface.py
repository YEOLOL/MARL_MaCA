...
class Environment:
    ...
    """
    def __init__(self, map_path, side1_obs_ind, side2_obs_ind, max_step=2000, render=False, render_interval=1000,
                 random_pos=False, log=False, random_seed=-1, external_render=False, side1_name='red',
                 side2_name='blue'):
        """
    ...
    def get_obs(self):
        ...
        if 'raw' == self.side1_obs_path:
            ...
            side1_actor_obs = self.agent1_obs.obs_construct(side1_obs_raw_dict)
        ...
        return side1_obs_raw_dict, side1_actor_obs, side2_obs
    ...
    def get_obs_raw(self):
        ...
        side2_detector_data_obs_list, side2_fighter_data_obs_list, side2_joint_data_obs_dict = self.env.get_obs_raw()
        # print(side1_fighter_data_obs_list[0])
