...
class Agent(BaseAgent):
    def __init__(self):
        ...
        self.obs_ind = 'simple1'
        if not os.path.exists('model/simple1/model.pkl'):
            print('Error: agent simple1 model data not exist!')
            exit(1)
